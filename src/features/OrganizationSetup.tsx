  ...
  return (
    <button
      ...
      onMouseOver={(e) => {
        ...
        e.currentTarget.style.borderColor = '#b8c6d6';
      }}
      onMouseOut={(e) => {
        e.currentTarget.style.backgroundColor = '#ffffff';
        e.currentTarget.style.borderColor = '#cfd9e5';
      }}
      onClick={onClick}
    >
      {label}
